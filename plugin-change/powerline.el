...
(defface powerline-active1 '((t (:foreground "#BCF" :background "#444455" :inherit mode-line)))
  "Powerline face 1."
  :group 'powerline)

(defface powerline-active2 '((t (:foreground "#ABE" :background "#3a3a4a" :inherit mode-line)))
  "Powerline face 2."
  :group 'powerline)

(defface powerline-active3 '((t (:foreground "#9AD" :background "#333344" :inherit mode-line)))
  "Powerline face 3."
  :group 'powerline)
...
(eval-after-load 'evil
  '(progn
     (defface powerline-evil-insert-face
       '((((class color))
          :foreground "white" :background "#3A3" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-normal-face
       '((((class color))
          :foreground "white" :background "DodgerBlue3" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-visual-face
       '((((class color))
          :foreground "white" :background "#AC3" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-motion-face
       '((((class color))
          :foreground "white" :background "cyan4" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-replace-face
       '((((class color))
          :foreground "white" :background "#D55" :weight bold :inherit mode-line)
         (t (:weight bold)))
     ...
     (defface powerline-evil-operator-face
       '((((class color))
          :foreground "white" :background "IndianRed4" :weight bold :inherit mode-line)
         (t (:weight bold)))
